...
def dashboard(request):
    ...
    context = {
        ...
        'pipeline_items': [
            {'name': 'Application', 'amount': D('1996.0'), 'percentage': D('100') , "background_color": "#1F3A52", "color": "#fff"},
            {'name': 'Credit Analysis', 'amount': D('644.0'), 'percentage': D('32') * 1, "background_color": "#41A186", "color": "#fff"},
            {'name': 'Risk Analysis', 'amount': D('153.0'), 'percentage': D('7.6') * 2, "background_color": "#7ebf5d", "color": "#000"},
            {'name': 'Processing', 'amount': D('110.0'), 'percentage': D('5.5') * 2, "background_color": "#b5e09f", "color": "#000"},
            {'name': 'Disbursement', 'amount': D('60.0'), 'percentage': D('3') * 2, "background_color": "#D3F689", "color": "#000"},
        ],
